...
const navItems: NavItem[] = [
  ...
  },
  {
    icon: <BoxCubeIcon />,
    key: "content",
    subItems: [{ key: "projects", path: "/projects" }, { key: "tools", path: "/tools" }, { key: "founders", path: "/founders" }],
  },
  {
    icon: <UserCircleIcon />,
    key: "company",
  ...
  },
  {
    key: "consultation",
    icon: <CalenderIcon />,
    subItems: [{ key: "bookings", path: "/bookings" }, { key: "consultationSettings", path: "/consultation" }],
  },
  {
    key: "communications",
    icon: <TableIcon />,
    subItems: [{ key: "messages", path: "/messages", pro: false }, { key: "auditLogs", path: "/audit-logs", pro: false }],
  },
  {
    key: "administration",
    icon: <PageIcon />,
